    ...
    */
    ...
    'connections' => [
        ...
        'mysql' => [
            ...
            'database' => env('DB_DATABASE', 'hiadmin_stag_db'),
        ...
        'mysql2' => [
            'driver' => 'mysql',
            'url' => env('DATABASE_SECCOND_URL'),
            'host' => env('DB_SECCOND_HOST', '127.0.0.1'),
            'port' => env('DB_SECCOND_PORT', '3306'),
            'database' => env('DB_SECCOND_DATABASE', 'forge'),
            'username' => env('DB_SECCOND_USERNAME', 'forge'),
            'password' => env('DB_SECCOND_PASSWORD', ''),
            'unix_socket' => env('DB_SECCOND_SOCKET', ''),
            'charset' => 'utf8mb4',
            'collation' => 'utf8mb4_unicode_ci',
            'prefix' => '',
            'prefix_indexes' => true,
        ...
        'mysql3' => [
            ...
            'database' => env('DB_THIRD_DATABASE', 'hihdi_db'),
