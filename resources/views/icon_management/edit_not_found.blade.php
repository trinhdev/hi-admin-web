                ...
                <div class="col-sm-9">
                    <div class="card card-info">
                        ...
                        <div class="card-footer">
                            <button type="button" onClick="cancelButton('{{ (!empty(Session::get('approved_data'))) ? route('iconapproved.index') : route('iconmanagement.index') }}', false)" class="btn btn-default float-right" style="margin-left: 5px">Đóng</button>
                        </div>
                    </div>
                </div>
            </div>
