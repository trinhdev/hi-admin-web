                            ...
                            <table class="table table-flush align-middle table-row-bordered table-row-solid gy-4 gs-9">
                                ...
                                <thead class="border-gray-200 fs-5 fw-bold bg-lighten">
                                    <tr>
                                        ...
                                        <th class="min-w-100px">OTP</th>
                                        <th class="min-w-100px">Time OTP</th>
                                        <th class="min-w-150px">Number Phone</th>
                                        <th class="min-w-150px">Set OTP</th>
                                        ...
                                        <td>
                                            <form action="#" method="POST">
                                                <div class="form-group" style="display:flex; padding: 5px ">
                                                    <input type="text" class="form-control" id="otp-token" name="otp-token" placeholder="Enter new otp">
