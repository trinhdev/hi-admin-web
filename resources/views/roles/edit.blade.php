            ...
            <div class="col-sm-12">
                <div class="card card-info">
                    <div class="card-header">
                        <h3 class="card-title">Infomation {{$controller}}</h3>
                    </div>
                    <!-- /.card-header -->
                    <!-- form start -->
                    {!! Form::open(array('url' => Config::get('app.backendUrl').'/'.$controller.'/save','method'=>'post' ,'id' => 'form-view','action' =>'index','class'=>'form-horizontal','enctype' =>'multipart/form-data','onsubmit'=>"handleSubmit(event)")) !!}
                    ...
                    <div class="card-body">
                        <div class="form-group row">
                            ...
                            <div class="col-sm-10">
                                <input type="name" class="form-control" id="name" placeholder="Role Name" name="role_name" value="@if(!empty($data)){{$data->role_name}}@endif">
                            </div>
                        </div>
