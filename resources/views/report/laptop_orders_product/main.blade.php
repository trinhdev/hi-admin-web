    ...
    <section class="content">
        <div class="container-fluid">
            <div class="card card-body col-sm-12">
                <div>
                    <form id="filter-form" class="row form-inline" action="{{ route('laptopordersbyproduct.index') }}" method="GET">
                        ...
                        <div class="col-sm-4 form-group">
                            ...
                            <div class="col-md-6">
                                <select class="js-example-basic-multiple js-states form-control" name="merchant_id[]" multiple="multiple" data-size="10" id="merchant_id">
                        ...
                        <div class="col-sm-4 form-group">
                            ...
                            <div class="col-md-6">
                                <select class="js-example-basic-multiple js-states form-control" name="agent_id[]" multiple="multiple" style="width: 100%" id="agent_id">
                        ...
                        <div class="col-sm-6 form-group">
                            ...
                            <div class="col-md-6">
                                <select name="product_id[]" multiple="multiple" data-size="10" id="product_id" class="js-example-basic-multiple js-states form-control">
                                    @foreach ($products as $product)
                                        ...
                                        @else
                                            <option value="{{ $product['product_id']  }}">{{ $product['sku'] }} - {{ $product['product_name'] }}</option>
                                        @endif
                                    @endforeach
                                </select>  
                            </div>
                ...
                <div id="report-table">
                    {{-- @include('report.laptop_orders_product.ncc') --}}
                    {{-- {{ $dataTable->table() }} --}}
                    {{ $nccDataTable->table() }}
                    {{ $merchantDataTable->table() }}
                    {{ $dataTable->table() }}
...
@push('scripts')
    ...
    {{-- {{ $dataTable->scripts() }} --}}
    {{-- {{ $renderNccTable->scripts() }} --}}
    {{ $nccDataTable->scripts() }}
    {{ $merchantDataTable->scripts() }}
    {{ $dataTable->scripts() }}
