                                ...
                                <div class="card-body">
                                    ...
                                    {!! Form::open(array('url' => route('ftel_phone.store'),'method'=>'post' ,'enctype' =>'multipart/form-data')) !!}
                                        ...
                                        <div class="form-group">
                                            ...
                                            <ol class="breadcrumb">
                                                <ul>
                                                    <b>Note</b>: Nhập bé hơn {{ LIMIT_PHONE }} số cách nhau bằng dấu phẩy (đối với file exel, lưu 1 cột duy nhất theo hàng dọc, tải file mẫu <a href="https://docs.google.com/spreadsheets/d/1ifAR0UwfdV03Sidcshjvwl1pn1YmYBD9/edit?usp=sharing&ouid=113322866597815571901&rtpof=true&sd=true" target="_blank"> <b> tại đây</b></a>)
                                                </ul>
                                            </ol>
                                            </nav>
                                        </div>
