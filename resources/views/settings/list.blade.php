                    ...
                    <div class="col-md-3">
                        ...
                        <ul class="nav navbar-pills navbar-pills-flat nav-tabs nav-stacked">
                            <li class="settings-group-general">
                                <a href="/settings/2?group=general" data-group="general">
                            ...
                            <li class="settings-group-cronjob">
                                <a href="/settings/2?group=cronjob" data-group="cronjob">
                            ...
                            <li class="settings-group-misc">
                                <a href="/settings/2?group=misc" data-group="misc">
