<a href="http://perfex.local/admin/settings?group=update"
   class="tw-flex tw-items-center tw-mb-2 tw-ml-3 settings-group-system-update">
    ...
    Cập nhật hệ thống </a>
<a href="http://perfex.local/admin/settings?group=info"
