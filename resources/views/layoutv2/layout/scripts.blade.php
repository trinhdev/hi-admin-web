...
<script type="text/javascript" id="app-js" src="{{ asset('assets/js/main.js?v=3.0.4')}}"></script>
...
<script type="text/javascript" id="fullcalendar-lang-js" src="{{ asset('assets/plugins/daterangepicker/daterangepicker.js')}}"></script>
<script type="text/javascript" id="fullcalendar-lang-js" src="{{ asset('custom_js/javascript.js')}}"></script>
<script>
