                ...
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb">
                        <li class="breadcrumb-item" aria-current="page">
                            <p>*** LƯU Ý ***<br>
                                - Chỉ được nhập tối đa 30.000 số điện thoại chuẩn định dạng số điện thoại Việt Nam cách nhau bằng dấu phẩy,(nếu như tải lên file exel, lưu số điện thoại theo 1 cột duy nhất theo hàng dọc, tải file mẫu <a href="https://docs.google.com/spreadsheets/d/1ifAR0UwfdV03Sidcshjvwl1pn1YmYBD9/edit?usp=sharing&ouid=113322866597815571901&rtpof=true&sd=true" target="_blank"> <b> tại đây</b><a/><br>
                                ...
                                - Các trường hợp xảy ra lỗi ngoại lệ vui lòng liên hệ <a
                                    href="https://zalo.me/0354370175" target="_blank"><b> hỗ trợ</b></a>
                            </p> <br>
                        </li>
                    </ol>
                </nav>
                <div class="col-12">
                    <form id="importExcel">
                        <div class="form-group">
                            <label for="number_phone"><span class="required_red_dot">Nhập vào danh sách số điện thoại</span> <br>
