        ...
        <div class="post d-flex flex-column-fluid" id="kt_post">
            ...
            <div id="kt_content_container" class="container-xxl">
                ...
                <div class="row row-cols-1 row-cols-md-2 row-cols-xl-3 g-5 g-xl-9">
                    <!--begin::Col-->
                    <div v-for="item in group" :key="item.group_code" class="col-md-4">
                        <!--begin::Card-->
                        <div class="card card-flush h-md-100">
                            ...
                            <div class="card-body pt-1">
                                ...
                                <div class="d-flex flex-column text-gray-600">
                                    <div v-for="permission in item.permissions" :key="permission.permision_code" class="d-flex align-items-center py-2">
                                        <span class="bullet bg-primary me-3">
                                        </span>{{ permission.permission_name }}
                                    </div>
                ...
                <edit-role :rolegroup="role_group"></edit-role>
                <!--end::Modals-->
            </div>
            <!--end::Container-->
        </div>
