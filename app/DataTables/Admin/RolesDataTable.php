            ...
            ->editColumn('action', function ($row) {
                return '
                    <div class="tw-flex tw-items-center tw-space-x-3">
                        ...
                        <a href="#" onclick="dialogConfirmWithAjax(deleteRoles, this)" data-name="' . $row->name . '"class="tw-text-neutral-500 hover:tw-text-neutral-700 focus:tw-text-neutral-700" >
