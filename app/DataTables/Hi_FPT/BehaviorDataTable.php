...
class BehaviorDataTable extends DataTable
{
    /**
    ...
    protected function getColumns()
    {
        return [
            ...
            Column::make('Bé hơn hoặc bằng 2'),
            Column::make('Từ 2 đến 4'),
            Column::make('Lớn hơn hoặc bằng 5')
        ];
    }
