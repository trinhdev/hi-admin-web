...
class AppController extends BaseController
{
    ...
    public function postChart(Request $request)
    {
        ...
        $data_month = Cache::remember('data_month', 60, function () {
            return DB::table('app_log')
        ...
        $data_month_user_current = Cache::remember('data_month_user_current', 60, function () {
            return [
                [
        ...
        $data_day_user = Cache::remember('data_day_user', 60, function () {
            return DB::table('app_log')
